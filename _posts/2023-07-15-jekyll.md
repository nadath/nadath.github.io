...
When faced with a self-sabotaging tendency, I decided I have to make calculated decisions and never one on impluse. With numbers and calculations, I was convinced I can only quit if I have secured a new job. Or be patient for a few more years until I have enough to pay back my study loans.  

I digged through [Hiredly](https://my.hiredly.com/), which I couldn't help but admire because of its cool and simple UI.

I had a tiny problem, though. I was cluesless about what I really wanted to do. 
...
But scratch "from scratch". It wasn't entirely from scratch.
